...
const FICHA_RUNTIME_MAP = [
  ...
  {
    primitive: "SingaporeBars", kinds: ["singapore-bars", "ratio-table", "story-bars", "partes-iguais-f45", "fracao-numero-f72", "fracoes-equivalentes-f73", "porcentagem-f87", "jornal-turma-f64", "media-chance-f83", "linguagem-letras-f89"],
    componentFiles: [component("SingaporeBars"), component("SingaporeBarsStage"), component("StoryBarsStage"), component("PartesIguaisStage"), component("FracaoNumeroStage"), component("FracoesEquivalentesStage"), component("PorcentagemStage"), component("JornalTurmaStage"), component("MediaChanceStage"), component("LinguagemLetrasStage")],
    builderKinds: ["storypanel"], specializedBuilderIds: ["N5.01", "N5.02", "N5.03", "N6.03", "PE.02", "PE.03", "AL.07"], rendererKinds: ["singapore-bars", "story-bars", "partes-iguais-f45", "fracao-numero-f72", "fracoes-equivalentes-f73", "porcentagem-f87", "jornal-turma-f64", "media-chance-f83", "linguagem-letras-f89"],
    note: "W15/F45, W16/F72 e W18/F73 reutilizam SingaporeBars; F73 compara barras de mesmo comprimento. W22/F87 compõe Quadrado100 + SingaporeBars. W25/F64 realiza o modo vertical em JornalTurmaStage; não cria primitiva nova. W31/F83 realiza média e chance em MediaChanceStage, preservando SingaporeBars como primitiva autoral. W38/F89 compõe SingaporeBars + plain para ligar quantidade visível e regra algébrica geral.",
  },
