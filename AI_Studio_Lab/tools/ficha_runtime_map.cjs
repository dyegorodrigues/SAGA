...
const FICHA_RUNTIME_MAP = [
  ...
  { primitive: "TenFrame", kinds: ["tenframe", "moldura", "bond", "plain", "material-dourado", "dobros-f32", "fazer-dez-f33"], componentFiles: [component("TenFrame"), component("MolduraStage"), component("NumberBond"), component("MaterialDouradoStage"), component("DobrosStage"), component("FazerDezStage")], builderKinds: ["tenframe", "moldura", "bond", "plain"], specializedBuilderIds: ["N3.06", "N3.07"], rendererKinds: ["tenframe", "moldura", "bond", "plain", "material-dourado", "dobros-f32", "fazer-dez-f33"], note: "MaterialDouradoStage compõe MaterialDourado + TenFrame. W54/F32/N3.06 usa a moldura para UMA fileira do dobro: preenchida com o total, ela seria a resposta desenhada na tela. W55/F33/N3.07 usa DUAS molduras: a criança fecha a primeira em dez por toque e a sobra começa a segunda, tornando visível a quebra da parcela — sem arrasto, alvo grande, porque precisão de dedo nunca é requisito para demonstrar compreensão." },
