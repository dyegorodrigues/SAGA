...
const FICHA_RUNTIME_MAP = [
  ...
  {
    primitive: "InteractiveNumberLine", kinds: ["numberline", "numberline-f19", "skip-count-f30", "fracao-numero-f72", "reta-completa-f84", "operar-negativos-f85", "voltar-contando-f31"],
    componentFiles: [component("InteractiveNumberLine"), component("Reta20Stage"), component("SkipCountStage"), component("FracaoNumeroStage"), component("RetaCompletaStage"), component("OperarNegativosStage"), component("VoltarContandoStage")],
    builderKinds: ["numberline"], specializedBuilderIds: ["AL.03", "N5.02", "N7.01", "N7.02", "N3.04"], rendererKinds: ["numberline", "numberline-f19", "skip-count-f30", "fracao-numero-f72", "reta-completa-f84", "operar-negativos-f85", "voltar-contando-f31"],
  ...
  { primitive: "TenFrame", kinds: ["tenframe", "moldura", "bond", "plain", "material-dourado", "dobros-f32"], componentFiles: [component("TenFrame"), component("MolduraStage"), component("NumberBond"), component("MaterialDouradoStage"), component("DobrosStage")], builderKinds: ["tenframe", "moldura", "bond", "plain"], specializedBuilderIds: ["N3.06"], rendererKinds: ["tenframe", "moldura", "bond", "plain", "material-dourado", "dobros-f32"], note: "MaterialDouradoStage compõe MaterialDourado + TenFrame. W54/F32/N3.06 usa a moldura para UMA fileira do dobro: preenchida com o total, ela seria a resposta desenhada na tela." },
