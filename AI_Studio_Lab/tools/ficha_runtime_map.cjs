...
const FICHA_RUNTIME_MAP = [
  ...
  {
    primitive: "InteractiveNumberLine", kinds: ["numberline", "numberline-f19", "skip-count-f30", "fracao-numero-f72", "reta-completa-f84", "operar-negativos-f85", "voltar-contando-f31", "voltar-pelo-dez-f34"],
    componentFiles: [component("InteractiveNumberLine"), component("Reta20Stage"), component("SkipCountStage"), component("FracaoNumeroStage"), component("RetaCompletaStage"), component("OperarNegativosStage"), component("VoltarContandoStage"), component("VoltarPeloDezStage")],
    builderKinds: ["numberline"], specializedBuilderIds: ["AL.03", "N5.02", "N7.01", "N7.02", "N3.04", "N3.08"], rendererKinds: ["numberline", "numberline-f19", "skip-count-f30", "fracao-numero-f72", "reta-completa-f84", "operar-negativos-f85", "voltar-contando-f31", "voltar-pelo-dez-f34"],
