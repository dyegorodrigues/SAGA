...
const FICHA_RUNTIME_MAP = [
  ...
  {
    primitive: "Balanca",
    kinds: ["balanca", "medidas", "igualdade-equilibrio-f46", "expressao-f77", "problemas-medida-f82"],
    componentFiles: [component("Balanca"), component("MedidasStage"), component("IgualdadeEquilibrioStage"), component("ExpressaoF77Stage"), component("ProblemasMedidaStage")],
    builderKinds: ["balanca", "medidas"], specializedBuilderIds: ["AL.05", "AL.06", "GM.09"],
    rendererKinds: ["balanca", "medidas", "igualdade-equilibrio-f46", "expressao-f77", "problemas-medida-f82"],
