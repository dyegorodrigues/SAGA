...
const FICHA_RUNTIME_MAP = [
  ...
  {
    primitive: "Quadrado100", kinds: ["hundred-chart", "frac-shade", "quadrado100-f36", "tabuada", "skip-count-f30", "decimos-centesimos-f75", "contas-virgula-f76", "porcentagem-f87", "primos-divisores-f70", "centena-f37", "numeros-grandes-f65"],
    componentFiles: [component("Quadrado100"), component("Quadrado100Stage"), component("TabuadaStage"), component("SkipCountStage"), component("DecimalStage"), component("ContasVirgulaStage"), component("PorcentagemStage"), component("PrimosDivisoresStage"), component("CentenaStage"), component("NumerosGrandesStage")],
    builderKinds: ["tabuada"], specializedBuilderIds: ["N2.02", "AL.03", "N6.01", "N6.02", "N6.03", "N4.11", "N2.04", "N2.05"], rendererKinds: ["quadrado100-f36", "tabuada", "skip-count-f30", "decimos-centesimos-f75", "contas-virgula-f76", "porcentagem-f87", "primos-divisores-f70", "centena-f37", "numeros-grandes-f65"],
  ...
  {
    primitive: "SingaporeBars", kinds: ["singapore-bars", "ratio-table", "story-bars", "partes-iguais-f45", "fracao-numero-f72", "fracoes-equivalentes-f73", "porcentagem-f87", "jornal-turma-f64", "media-chance-f83", "estatistica-chance-f95", "linguagem-letras-f89", "soma-fracoes-f74", "razao-proporcao-f88", "pictograma-f56"],
