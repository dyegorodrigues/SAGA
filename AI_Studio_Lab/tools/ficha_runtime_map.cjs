...
const FICHA_RUNTIME_MAP = [
  ...
  { primitive: "ScatteredItems", kinds: ["scattered"], componentFiles: [component("ScatteredItems")], builderKinds: ["scattered"], rendererKinds: ["scattered"] },
  {
    ...
    specializedBuilderIds: ["GE.03", "N5.01"],
    rendererKinds: ["shapecanvas", "detetive-formas-f58", "partes-iguais-f45"],
    note: "W13/F58 desenha por FiguraDesenhada do próprio ShapeCanvas. W15/F45 reutiliza a mesma FiguraDesenhada nos círculos e compõe SingaporeBars nos níveis de barra; owner especializado N5.01."
  },
  {
    ...
    specializedBuilderIds: ["N5.01"],
    rendererKinds: ["singapore-bars", "story-bars", "partes-iguais-f45"],
    note: "N3.10/F20 compõe StoryPanel + SingaporeBars. W15/F45 usa SingaporeFractionBar, exportação da própria SingaporeBars, junto do ShapeCanvas no palco PartesIguaisStage."
  },
  {
