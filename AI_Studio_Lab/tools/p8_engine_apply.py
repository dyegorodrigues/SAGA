...
# Estado persistente do Dojo: amplia o contrato existente sem quebrar saves v1.
replace_once(
    "src/types.ts",
...
Path("src/curriculum/motores/jardimEngine.ts").write_text('''import type { JardimTrackState, Progress } from "../../types";
...
Path("src/curriculum/motores/jardimEngine.test.ts").write_text('''import { describe, expect, it } from "vitest";
...
print("P8 engine patch preparado")
