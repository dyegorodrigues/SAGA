...
export const COVERAGE_MIGRATIONS: readonly CoverageMigration[] = [
  ...
  { id: "W33-GE.07", competence: "GE.07", rationale: "F79 materializada no PoligonosStage, compondo ShapeCanvas + DragGroup para identificar, classificar e construir polígonos por propriedades. O portão inativo final af1e657a usa CI 31915992534 + transversal 31915992567; promoção e ledger entram atomicamente somente após a certificação desse SHA, sem presumir divergência.", delta: { composer: 1, fallback: -1, served: 1 } },
] as const;
