...
export const COVERAGE_MIGRATIONS: readonly CoverageMigration[] = [
  ...
  },
  {
    id: "W63-N3.12",
    competence: "N3.12",
    rationale: "F40 A Dezena Desmonta — décima primeira das doze competências sem ficha autoral, e o espelho da N3.11. Quando não há unidades suficientes para tirar, uma dezena é desmontada em dez unidades. É mais difícil que a adição por um motivo que a ficha canônica nomeia: ao somar, a criança junta e o excesso é evidente; ao subtrair, ela precisa PERCEBER A FALTA antes de agir. Palco composto InteractiveVertical + MaterialDourado: a conta armada é onde o algoritmo mora, o material é onde desmontar uma dezena deixa de ser marquinha em cima do algarismo e vira uma barra virando dez cubinhos. O material sai do L4 em diante, porque a ponte já foi atravessada. A conta armada entra sem onAnswer: quem responde é a barra do palco, e duas superfícies aceitando resposta dariam dois caminhos para o mesmo acerto. Invariante do gerador: a unidade do topo é SEMPRE menor que a da base — sem impasse não há empréstimo a ensinar e o nível vira N3.09 outra vez. O teste nominal cobrou um reparo antes da promoção: quando a diferença das unidades iguala a unidade do topo, o resultado de inverter cai exatamente sobre o minuendo, e o mesmo número na barra significaria dois erros diferentes — inverteu para escapar e travou e devolveu o de cima. Um distrator que quer dizer duas coisas não diagnostica nenhuma, então esses casos passaram a ser recusados no sorteio, junto com aqueles em que inverter acertaria por acidente. O L5 traz o caso mais difícil da aritmética elementar, emprestar de uma coluna com zero, e ali o zero no meio é obrigatório em vez de sorteado. O legado gN3_12 sai de produção. Delta observado: +1 Composer, -1 legado.",
    delta: { composer: 1, legacy: -1 },
  },
  {
    id: "W64-N3.13",
    competence: "N3.13",
    rationale: "F41 Cálculo Mental e Estimativa — a última das doze competências sem ficha autoral. Com ela, as 90 competências do DAG têm ficha. A ficha ensina o mecanismo de autocorreção: quem calcula 38+45 e responde 73 não percebe o erro; quem estimou oitenta percebe. O erro mais interessante da ficha é o IGNORA_CONFLITO — estimar oitenta, calcular setenta e três e seguir sem notar que as duas coisas não combinam —, e é por isso que o L4 mostra respostas prontas e pergunta qual é absurda: um nível que só pede estimativa pega apenas quem não sabe estimar, não quem não usa a própria estimativa. A CLASS-009 cobrou um reparo de projeto antes da promoção: a reta estava desenhada em todos os níveis, e nos de duas parcelas a soma caía às vezes exatamente sobre uma das dezenas marcadas, exibindo a resposta por acidente do sorteio. A reta passou a aparecer só onde é ferramenta — nos dois níveis que arredondam —, o que também é o que a ficha canônica nomeia ao declarar NumberLine mais plain; e as parcelas ganharam piso de 25, para que a soma arredondada fique sempre além da última marca desenhada. O L5 fecha a barra até a criança declarar por onde foi: num nível de cálculo mental, chutar e acertar é indistinguível do domínio. A competência entra no registro da CLASS-009 como LEGITIMO por dois motivos separados e ambos estruturais: no nível que arredonda a resposta é uma das duas dezenas que cercam o número e escolher entre elas é a tarefa; no nível do absurdo as três candidatas precisam estar visíveis para poderem ser julgadas. O legado gN3_13 sai de produção. Delta observado: +1 Composer, -1 legado.",
    delta: { composer: 1, legacy: -1 },
  },
  {
    id: "W65-GM.04",
    competence: "GM.04",
    rationale: "F55 Que Horas São — a última competência no legado, e a que fecha a Jornada: com ela as 90 do DAG são servidas pelo Composer e o legado vai a zero. A ficha já existia mas não podia ser servida: tinha dois micros para cinco níveis e os níveis não declaravam micro nenhum. Ganhou a escada de cinco degraus dentro do escopo que a DECISAO-001 fixou — hora cheia, meia hora, as duas misturadas, problema de horas inteiras, e a leitura em palavras. Nenhum nível sorteia minuto que não seja zero ou trinta, e o teste nominal cobra isso em todos os cinco, para que a decisão de cânone não tenha porta dos fundos. O degrau escondido que a ficha canônica nomeia é o L2: às três e meia o ponteiro das horas fica ENTRE o 3 e o 4, e quem aprendeu que ele aponta para um número responde quatro e meia. Esse erro, o MEIA_HORA_ARREDONDA, é o motivo de a meia hora ser nível próprio em vez de mais um caso do primeiro, e ele está sempre na barra, etiquetado. O relógio entra travado: arrastar ponteiro é competência da GM.06, e uma tela que aceita produzir a hora antes de saber ler uma ensinaria na ordem errada. O digital fica para o fecho, depois do acerto — antes dele seria o gabarito ao lado da pergunta. Os níveis que misturam as duas leituras exigem as duas por evidenciasDistintas, que é o §9 da F55 pedindo pelo menos uma meia hora no domínio. O legado gGM_04 sai de produção, e com ele o último gerador legado da Jornada. Delta observado: +1 Composer, -1 legado.",
    delta: { composer: 1, legacy: -1 },
  },
] as const;
