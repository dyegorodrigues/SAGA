 ...
 *  - kind "tenframe"  → moldura de 10 (caixa 2×5) para subitização
 */
...
export function gMatBond(lvl: number): Question {
  ...
  // N1-N4 — CONCRETO na moldura de 10: a criança CONTA os quadradinhos vazios.
...
/* ---------------- Moldura de 10 🔟 (Ten Frame / subitização) ----------------
...
export const TRACKS_MAT_ELITE_PRE: Track[] = [
  { id: "olho", name: "Olhômetro", icon: "👀", color: C.grape, dark: C.grapeDark, gen: gMatOlho, prereqs: [], lvlSkills: SK_OLHO },
  { id: "amigos", name: "Amigos do 10", icon: "🤝", color: C.mint, dark: C.mintDark, gen: gMatBond, prereqs: ["soma"], lvlSkills: SK_AMIGOS },
  { id: "moldura", name: "Moldura de 10", icon: "🔟", color: C.ocean, dark: C.oceanDark, gen: gMatTenFrame, prereqs: ["contar"], lvlSkills: SK_MOLDURA },
];

export const TRACKS_MAT_ELITE_ANO1: Track[] = [
  { id: "olho", name: "Olhômetro", icon: "👀", color: C.grape, dark: C.grapeDark, gen: gMatOlho, prereqs: [], lvlSkills: SK_OLHO },
  { id: "amigos", name: "Amigos dos Números", icon: "🤝", color: C.mint, dark: C.mintDark, gen: gMatBond, prereqs: ["soma"], lvlSkills: SK_AMIGOS },
  { id: "moldura", name: "Moldura de 10", icon: "🔟", color: C.ocean, dark: C.oceanDark, gen: gMatTenFrame, prereqs: ["seq"], lvlSkills: SK_MOLDURA },
];
