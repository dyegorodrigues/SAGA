...
export const SUBJECTS: Subject[] = [
  {
    ...
    icon: "🌍",
    novo: true,
    tracks: { pre: TRACKS_MUNDO_PRE, ano1: TRACKS_MUNDO_ANO1 },
  },
  {
    id: "mat",
    nome: "Matemática",
  ...
  },
  {
    ...
    icon: "📖",
    novo: true,
    tracks: { pre: TRACKS_PORT_PRE, ano1: TRACKS_PORT_ANO1 },
  },
  {
    id: "eng",
    nome: "Inglês",
    icon: "🇺🇸",
    novo: true,
    tracks: { pre: TRACKS_ENG_PRE, ano1: TRACKS_ENG_ANO1 },
  },
  {
    id: "sci",
    nome: "Ciências",
    icon: "🔬",
    novo: true,
    tracks: { pre: TRACKS_SCI_PRE, ano1: TRACKS_SCI_ANO1 },
  },
];

/** Todas as trilhas de uma série, atravessando as matérias. */
export function tracksForGrade(grade: "pre" | "ano1"): Track[] {
