...
export function AdminGodPanel({ state, onUpdateState, onClose }: AdminGodPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-3xl w-full max-w-4xl border-4 border-indigo-500 shadow-2xl overflow-hidden flex flex-col my-8 max-h-[90vh]">
