...
2. **Duas retas numéricas empilhadas**, cada uma num contêiner de largura idêntica. Cada reta has: uma linha horizontal com setas nas pontas, marcas verticais igualmente espaçadas, numerais sob as marcas, o número de partida destacado com moldura, e **arcos curvos acima da linha** ligando cada salto.
