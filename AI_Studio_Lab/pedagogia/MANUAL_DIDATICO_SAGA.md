...
*Didática construída nesta versão (F4). Curta porque a strand é curta — mas o luto conceitual é grande.*

## Por que trava
Até aqui, "menor que zero" não existia — e a subtração "sempre diminui". Os negativos chegam na escola como regrinhas de sinal decoradas ("menos com menos dá mais") sem nenhum corpo. Sintoma: calcula −3+5 chutando o sinal; acha que −7 > −2 "porque 7 é maior".

## A escada e a primeira vez
```
 Nível 2: Operar na reta (andar e virar)        → N7.02
 Nível 1: A reta completa — ordem e oposto      → N7.01
 Nível 0: Frio e dívida — o negativo vivido     → N7.01a
```
**▶️ Primeira vez:** o termômetro da montanha. *"Estava 3 graus. A noite chegou e a temperatura DESCEU 5. Onde parou o ponteiro?"* A criança arrasta o mercúrio — e ele passa do zero e continua descendo: −2. O número negativo nasce como LUGAR (abaixo do zero), não como símbolo. Os dois cenários canônicos: temperatura (termômetro vertical) e dinheiro/dívida ("tenho 3, devo 5 — fico devendo 2"). O elevador com subsolo completa o trio.

## Nível a nível
- **N7.01 — a reta espelhada:** o zero como espelho; −4 é o REFLEXO do 4. Ordem: 🧒 *o erro-definidor:* −7 > −2 "porque 7>2" — a cura é o termômetro (*"qual dia estava MAIS FRIO?"*) e a reta (mais à esquerda = menor, sempre). Distrator obrigatório: a comparação pelos valores absolutos. Oposto e o valor absoluto como "distância até o zero" (distância não tem sinal!).
- **N7.02 — andar na reta:** somar = andar pra direita; subtrair = andar pra esquerda; o SINAL do número diz de onde parte / o "−" na frente VIRA o boneco. −3+5: começa no −3, anda 5 pra direita, chega no 2. Subtrair negativo (5−(−2)) só no fim, como "tirar uma dívida = ganhar" (o gelo saindo do copo esquenta a média). 🧒 *Regra de ouro:* nenhuma regrinha de sinais decorada ANTES da reta estar no músculo — a regra é a legenda do caminhar, nunca o contrário.
...
# 🎯 O MÉTODO DE BARRAS — RESOLVER PROBLEMAS DE VERDADE (transversal)
