...
2. **A escada de proficiência (níveis 1→5 / ZDP)** da Bíblia: é *quão bem* a criança domina uma competência específica, medida pelo motor (3 acertos sobe, 3 erros desce).
