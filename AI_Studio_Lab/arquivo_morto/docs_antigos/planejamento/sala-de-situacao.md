...
1. **Motor AULINHA 🎬 (o pedido nº1 do Zeus): animações que ENSINAM.** Generalizar o que
...
5. **Miudezas do delta:** Probleminhas N5 (modelo de barras) · Formas N5 (sólidos) ·
   Detetive N4 (grade 4×4 real, kind `grid`).
...
7. **Fase C:** ativar grafo `prereqs` + Modo Gênio 🚀 (o `dom` já existe) — a porta do
   2º ano (reagrupamento, multiplicação como grupos, frações com pizza).
...
**🗺️ VISUAL:** `docs/atlas.html` — o mapa visual de tudo (docs em 3 camadas + currículo
...
| **`didatica/didatica-adicao.md`** | a didática científica de adição detalhada de 4 a 7+ anos (Singapura/CPA) |
| **`didatica/didatica-subtracao.md`** ← novo | a didática científica da subtração (Tirar, Comparar, Parte-Todo, Empréstimo Visual) |
| **`didatica/didatica-multiplicacao.md`** ← novo | a didática científica da multiplicação (Matrizes, Modelo de Área, Distribuição) |
| **`didatica/didatica-divisao.md`** ← novo | a didática científica da divisão (Partição Justa, Medida, Restos e Chave Viva) |
| **`arquitetura-skills-flow.md`** | o Flow Engine de engajamento, Tamagotchi leve e Engenharia de Skills de IA |
...
| **`trajetoria-meu-lugar-no-mundo.md`** ← novo | a trajetória (6 passos) da geografia v2, AGUARDANDO aprovação do Zeus antes de codar |
...
### Nova Arquitetura de Documentos Didáticos (`/docs/didatica/`)
- `fracoes.md` - Do concreto ao fracionário (Partilha e Equivalência)
- `geometria.md` - Pensamento geométrico e espacial (Van Hiele)
- `medidas.md` - Grandezas, Tempo e Sistema Monetário
- `logica-e-padroes.md` - O pensamento algébrico primitivo
- `ANALISE_E_BIBLIOGRAFIA.md` - A base científica e análise global do método
