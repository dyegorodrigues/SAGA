...
4. **Dojo:** 1 bloco por sessão, montado pelo Treino do Mestre — spec completa em `DOJO_SAGA.md` (força por fato, degraus, faixas, Jardim do Dojo para pré-leitores).
...
O motor não pergunta "quantos erros?"; pergunta **"qual é o PADRÃO do erro?"**. Quatro sensores, em ordem de precisão:
