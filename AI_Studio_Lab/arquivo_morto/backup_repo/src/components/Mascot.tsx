...
export const THEMES: Record<string, ThemeConfig> = {
  ...
  homem_aranha: {
    ...
    praise: [
      ...
      "Uau! Um salto espetacular direto na resposta certa! 🏙️",
  ...
  batman: {
    ...
    praise: [
      ...
      "Incrível! Nem o Coringa conseguiria vencer sua inteligência! 🖤"
    ],
  },
  elsa: {
    ...
    praise: [
      ...
      "Parabéns! Você domina a matemática com muita elegância! 👑",
  ...
  pikachu: {
    ...
    praise: [
      ...
      "Incrível! Você evoluiu suas habilidades matemáticas! ⭐",
  ...
  heroi: {
    ...
    emojis: ["⚡", "🛡️", "💥", "🦸", "🚀", "🌩️", "🧤", "💪", "🔥", "⭐"],
    praise: ["Incrível! Você tem superpoderes matemáticos! ⚡", "Super acerto! Você é o herói do dia! 💥", "Uau! Você salvou o dia com essa inteligência brilhante! 🦸", "Parabéns! Que força mental incrível! 💪", "Espetacular! Você brilha mais que o sol! 🌟"],
  },
  hulk: {
    nome: "Hulk", icon: "🟢", bg: ["#DCFCE7", "#F0FDF4"], burst: ["🟢", "💥", "🤜", "💜", "✨"],
    emojis: ["🤜", "🧱", "🦖", "💪", "💥", "🟢", "💜", "🩳", "🔥", "⭐"],
    praise: ["ESMAGADOR! Que acerto forte! 🤜", "Uau! Força incrível do Hulk verde! 💪", "Sensacional! Você superou esse desafio com inteligência! 💥", "Incrível! Hulk está super orgulhoso de você! 🟢", "Parabéns! Um salto gigante rumo ao acerto! 🧱"],
  },
  capitao_america: {
    nome: "Capitão", icon: "🛡️", bg: ["#DBEAFE", "#EFF6FF"], burst: ["🛡️", "⭐", "🔴", "🔵", "✨"],
    emojis: ["🛡️", "⭐", "🔴", "🔵", "🧢", "🎖️", "🏢", "💥", "🗽", "⭐"],
    praise: ["Excelente! Defesa e ataque impecáveis! 🛡️", "Uau! Acerto digno do líder dos heróis! ⭐", "Sensacional! Lançamento de escudo certeiro! 🔵", "Parabéns! Sua determinação é inabalável! 🎖️", "Incrível! Você é a força e justiça da equipe! 🔴"],
  },
  homem_ferro: {
    nome: "H. de Ferro", icon: "🦾", bg: ["#FEE2E2", "#FEF2F2"], burst: ["🤖", "🚀", "🔥", "💛", "✨"],
    emojis: ["🤖", "🚀", "🔥", "🦾", "🛠️", "⚙️", "🌟", "🟥", "🟨", "⭐"],
    praise: ["Gênio! Tecnologia de ponta e acerto perfeito! 🤖", "Uau! Seus propulsores te levaram direto ao acerto! 🚀", "Incrível! Armadura blindada contra erros! 🦾", "Sensacional! Reator Arc brilhando em potência máxima! 🔥", "Parabéns! Você calculou com precisão cirúrgica! 🛠️"],
  },
  bruxo: {
    nome: "Bruxo", icon: "🧙‍♂️", bg: ["#F3E8FF", "#F9F5FF"], burst: ["🧙‍♂️", "🪄", "🔮", "✨", "💜"],
    emojis: ["🧙‍♂️", "🪄", "🔮", "Castle", "🦉", "🧹", "🧪", "📜", "⭐", "🌟"],
    praise: ["Feitiço perfeito! Um acerto mágico! 🪄", "Uau! Você decifrou a alquimia dos números! 🔮", "Incrível! Alvo atingido com varinha mágica! 🧙‍♂️", "Espetacular! Sabedoria ancestral digna de Dumbledore! 📜", "Parabéns! Uma lição matemática fascinante! 🏰"],
  },
  futebol: {
    nome: "Futebol", icon: "⚽", bg: ["#D8F5DF", "#F0FFF4"], burst: ["⚽", "🏆", "⭐", "🥇", "✨"],
    emojis: ["⚽", "🥅", "🏆", "👟", "🧤", "🟨", "📣", "🎽", "🥇", "⭐"],
    praise: ["GOLAÇO! Você joga como um campeão! ⚽", "Que jogada linda! Nota dez para você! 🏆", "Isso aí! Chute certeiro direto pro gol! 👟", "Espetacular! Um acerto digno de troféu! 🥇", "Maravilovilho! Você brilha muito em campo! 🌟"],
  },
  musica: {
    nome: "Roqueiro", icon: "🎸", bg: ["#F1F5F9", "#F8FAFC"], burst: ["⚡", "🎸", "💀", "🤘", "✨"],
    emojis: ["🎸", "🥁", "🎹", "🎤", "⚡", "💀", "🤘", "🎧", "🎵", "⭐"],
    praise: ["Rock'n Roll! Solo de guitarra impecável e acerto épico! 🎸", "Sensacional! A plateia inteira foi ao delírio com esse show! 🎤", "Uau! Ritmo avassalador e resposta certeira! ⚡", "Parabéns! Você arrasou no palco com muito estilo! 🤘", "Espetacular! Sua inteligência é puro rock de primeira! 🎧"],
  },
  dino: {
    nome: "Dinos", icon: "🦖", bg: ["#E2F5D3", "#F4FFF0"], burst: ["🦖", "🌿", "⭐", "🦴", "✨"],
    emojis: ["🦖", "🦕", "🌋", "🥚", "🦴", "🌴", "🐊", "🍖", "🌿", "⭐"],
    praise: ["Uau! Um acerto jurássico e gigante! 🦖", "Sensacional! Que força incrível de dinossauro! 🦕", "Você arrasou! Descoberta digna de um cientista! 🌋", "Rawr! Que garra incrível! Nota dez! 🦴", "Parabéns! Você é dino-demais! 🌟"],
  },
  pantera_negra: {
...
export function ttsText(t: string): string {
  ...
  // Fix onomatopoeia spelling issue, e.g. "goool", "gooooool", "gooooollll"
  // If a word has multiple repeating 'o's or 'l's, simplify it so the TTS engine pronounces it naturally as "gool" instead of spelling G-O-O-L-L
  cleaned = cleaned.replace(/[gG]+[oO]{2,}[lL]+[lL]*/gi, "gool");
  
  // Simplify other long repeating characters to prevent spelling out letter by letter
  cleaned = cleaned.replace(/([a-zA-Z])\1{2,}/g, "$1$1");

  // Fix spatial descriptions to be more natural in PT-BR as requested by parents
  cleaned = cleaned
...
export function speak(text: string, opts: { rate?: number; pitch?: number; onEnd?: () => void; lang?: string } = {}) {
  try {
    ...
    const isEnglish = !!opts.lang && opts.lang.toLowerCase().startsWith("en");
    // Em inglês, não aplicamos as trocas de símbolos pt-BR (mas texto de inglês não tem +/=)
    const u = new SpeechSynthesisUtterance(ttsText(text));
    u.lang = opts.lang || "pt-BR";
    if (isEnglish && EN_VOICE) u.voice = EN_VOICE;
    else if (!isEnglish && VOICE) u.voice = VOICE;
    u.rate = opts.rate != null ? opts.rate : isEnglish ? 0.9 : 1.05;
    ...
    // Safeguard timeout to ensure transitions always execute even if browser synthesis stalls
    setTimeout(triggerEnd, 4500);
 ...
 */
export function TenFrame({ filled, filled2 = null }: { filled: number; filled2?: number | null }) {
  const Frame = ({ n }: { n: number }) => (
    <div className="grid grid-cols-5 gap-1 p-1.5 bg-white rounded-xl border-4 border-slate-300 shadow-md select-none">
      {Array.from({ length: 10 }).map((_, i) => (
        <div key={i} className="flex items-center justify-center rounded-md" style={{ width: 30, height: 30, background: i < n ? "" : "#F1F5F9", border: "2px solid #E2E8F0" }}>
