  ...
  return (
    <div className="mk-pop">
            ...
            <div key={k.id} className="mb-6 p-4 rounded-2xl border-2 border-slate-100 bg-white">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <button
                  ...
                  className={`px-2.5 py-1 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                    k.grade === "ano1" ? "bg-indigo-100 text-indigo-700 border-2 border-indigo-400" : "bg-slate-50 text-slate-500 border border-slate-200"
                  }`}
                >
                  🚀 1º Ano (6a)
                </button>
      ...
      <p className="mt-5 text-center text-xs text-slate-500 font-medium leading-relaxed px-2">
        A inteligência adaptativa de Matemágica promove autonomia e respeito ao ritmo de aprendizagem natural da infância.
      </p>
