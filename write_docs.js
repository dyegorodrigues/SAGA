...
fs.mkdirSync('./AI_Studio_Lab/pedagogia', { recursive: true });
fs.mkdirSync('./curriculum', { recursive: true });

const doc1 = `# 📖 A BÍBLIA DO SAGA
...
fs.writeFileSync('./AI_Studio_Lab/pedagogia/BIBLIA_DO_SAGA.md', doc1);
console.log('BIBLIA wrote successfully.');
