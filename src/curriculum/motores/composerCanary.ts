...
import { N2_01 } from "../fichas/jornada/N2.01"; import { N2_02 } from "../fichas/jornada/N2.02"; import { N2_03 } from "../fichas/jornada/N2.03"; import { N2_06 } from "../fichas/jornada/N2.06";
...
const COMPOSER_FICHAS: Record<string, FichaCompetencia> = {
  ...
  "N5.01":N5_01,"N5.02":N5_02,"N5.03":N5_03,"N6.01":N6_01,"N6.03":N6_03,"N7.01":N7_01,
  ...
  "N2.01":N2_01,"N2.02":N2_02,"N2.03":N2_03,"N2.06":N2_06,
  "AL.01":AL_01,"AL.02":AL_02,"AL.03":AL_03,"AL.04":AL_04,"AL.05":AL_05,"AL.06":AL_06,
  "GE.01":GE_01,"GE.02":GE_02,"GE.03":GE_03,"GE.04":GE_04,"GE.05":GE_05,"GE.06":GE_06,"GE.07":GE_07,"GE.08":GE_08,
  "GM.01":GM_01,"GM.02":GM_02,"GM.05":GM_05,"GM.07":GM_07,"GM.08":GM_08,"GM.09":GM_09,"GM.12":GM_12,
...
const SPECIALIZED_RUNTIME_KIND:Partial<Record<string,string>>={"N1.12":"numberline-f19","N2.01":"material-dourado","N2.02":"quadrado100-f36","N2.03":"comparacao-simbolica","N3.01":"visual-addition-f13","N3.02":"emojirow-riscar-f15","N3.03":"counting-on-f14","N4.01":"equal-groups-f97","N4.10":"divisao-longa-f69","N5.01":"partes-iguais-f45","N5.02":"fracao-numero-f72","N5.03":"fracoes-equivalentes-f73","N6.01":"decimos-centesimos-f75","N6.03":"porcentagem-f87","N7.01":"reta-completa-f84","AL.03":"skip-count-f30","AL.04":"regra-sequencia-f57","AL.05":"igualdade-equilibrio-f46","AL.06":"expressao-f77","GE.03":"detetive-formas-f58","GE.04":"solidos-geometricos-f59","GE.05":"mapa-tesouro-f60","GE.06":"angulos-f78","GE.07":"poligonos-f79","GE.08":"plano-cartesiano-f80","GM.05":"regua-f61","GM.07":"perimetro-f63","GM.08":"area-f81","GM.09":"problemas-medida-f82","PE.02":"jornal-turma-f64","PE.03":"media-chance-f83"};
