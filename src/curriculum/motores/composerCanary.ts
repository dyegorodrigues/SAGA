...
const COMPOSER_FICHAS: Record<string, FichaCompetencia> = {
  ...
  "N4.01": N4_01, "N4.03": N4_03, "N4.04": N4_04, "N4.06": N4_06, "N4.07": N4_07, "N4.08": N4_08, "N4.09": N4_09,
  "N5.01": N5_01, "N5.02": N5_02,
  // W18: F73 registrada e INATIVA.
  "N5.03": N5_03,
  "N6.01": N6_01,
...
const SPECIALIZED_BUILDERS: Partial<Record<string, SpecializedBuilder>> = {
  "N1.05": construirComparacaoQuantidadeQuestion, "N1.09": construirContagem20Question, "N1.12": construirReta20Question,
  "N2.01": construirDezenaUnidadesQuestion, "N2.02": construirQuadrado100Question, "N2.03": construirComparacaoSimbolicaQuestion,
  "N3.01": construirVisualAdditionQuestion, "N3.02": construirEmojiRowRiscarQuestion, "N3.03": construirCountingOnQuestion,
  "N4.01": construirEqualGroupsQuestion, "N5.01": construirPartesIguaisQuestion, "N5.02": construirFracaoNumeroQuestion,
  "N5.03": construirFracaoEquivalenteQuestion, "N6.01": construirDecimalQuestion,
  "AL.03": construirSkipCountF30Question, "AL.04": construirRegraSequenciaQuestion, "GE.03": construirDetetiveFormasQuestion,
  "GM.02": construirTempoCotidianoQuestion, "GM.05": construirReguaQuestion,
};
...
const SPECIALIZED_RUNTIME_KIND: Partial<Record<string, string>> = {
  ...
  "N5.01": "partes-iguais-f45", "N5.02": "fracao-numero-f72", "N5.03": "fracoes-equivalentes-f73", "N6.01": "decimos-centesimos-f75",
...
export function generateRegisteredFichaQuestion(id: string, level: number): Question {
  ...
  return specialized ? specialized(ficha, level) : Composer.generate(ficha, level);
}
