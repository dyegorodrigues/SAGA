...
import { GE_01 } from "../fichas/jornada/GE.01"; import { GE_02 } from "../fichas/jornada/GE.02"; import { GE_03 } from "../fichas/jornada/GE.03"; import { GE_04 } from "../fichas/jornada/GE.04"; import { GE_05 } from "../fichas/jornada/GE.05"; import { GE_06 } from "../fichas/jornada/GE.06";
...
const COMPOSER_FICHAS: Record<string, FichaCompetencia> = {
  ...
  "GE.01":GE_01,"GE.02":GE_02,"GE.03":GE_03,"GE.04":GE_04,"GE.05":GE_05,"GE.06":GE_06,
...
const SPECIALIZED_RUNTIME_KIND:Partial<Record<string,string>>={"N1.12":"numberline-f19","N2.01":"material-dourado","N2.02":"quadrado100-f36","N2.03":"comparacao-simbolica","N3.01":"visual-addition-f13","N3.02":"emojirow-riscar-f15","N3.03":"counting-on-f14","N4.01":"equal-groups-f97","N4.10":"divisao-longa-f69","N5.01":"partes-iguais-f45","N5.02":"fracao-numero-f72","N5.03":"fracoes-equivalentes-f73","N6.01":"decimos-centesimos-f75","N6.03":"porcentagem-f87","N7.01":"reta-completa-f84","AL.03":"skip-count-f30","AL.04":"regra-sequencia-f57","AL.05":"igualdade-equilibrio-f46","AL.06":"expressao-f77","GE.03":"detetive-formas-f58","GE.04":"solidos-geometricos-f59","GE.05":"mapa-tesouro-f60","GE.06":"angulos-f78","GM.05":"regua-f61","GM.07":"perimetro-f63","GM.08":"area-f81","GM.09":"problemas-medida-f82","PE.02":"jornal-turma-f64","PE.03":"media-chance-f83"};
