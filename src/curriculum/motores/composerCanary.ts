...
import { N5_01 } from "../fichas/jornada/N5.01"; import { N5_02 } from "../fichas/jornada/N5.02"; import { N5_03 } from "../fichas/jornada/N5.03"; import { N6_01 } from "../fichas/jornada/N6.01"; import { N6_03 } from "../fichas/jornada/N6.03"; import { N7_01 } from "../fichas/jornada/N7.01"; import { N7_02 } from "../fichas/jornada/N7.02";
import { AL_01 } from "../fichas/jornada/AL.01"; import { AL_02 } from "../fichas/jornada/AL.02"; import { AL_03 } from "../fichas/jornada/AL.03"; import { AL_04 } from "../fichas/jornada/AL.04"; import { AL_05 } from "../fichas/jornada/AL.05"; import { AL_06 } from "../fichas/jornada/AL.06"; import { AL_07 } from "../fichas/jornada/AL.07";
import { GE_01 } from "../fichas/jornada/GE.01"; import { GE_02 } from "../fichas/jornada/GE.02"; import { GE_03 } from "../fichas/jornada/GE.03"; import { GE_04 } from "../fichas/jornada/GE.04"; import { GE_05 } from "../fichas/jornada/GE.05"; import { GE_06 } from "../fichas/jornada/GE.06"; import { GE_07 } from "../fichas/jornada/GE.07"; import { GE_08 } from "../fichas/jornada/GE.08"; import { GE_09 } from "../fichas/jornada/GE.09";
...
const COMPOSER_FICHAS: Record<string, FichaCompetencia> = {
  ...
  "N5.01":N5_01,"N5.02":N5_02,"N5.03":N5_03,"N6.01":N6_01,"N6.03":N6_03,"N7.01":N7_01,"N7.02":N7_02,
  ...
  "AL.01":AL_01,"AL.02":AL_02,"AL.03":AL_03,"AL.04":AL_04,"AL.05":AL_05,"AL.06":AL_06,"AL.07":AL_07,
  "GE.01":GE_01,"GE.02":GE_02,"GE.03":GE_03,"GE.04":GE_04,"GE.05":GE_05,"GE.06":GE_06,"GE.07":GE_07,"GE.08":GE_08,"GE.09":GE_09,
...
const SPECIALIZED_RUNTIME_KIND:Partial<Record<string,string>>={"N1.12":"numberline-f19","N2.01":"material-dourado","N2.02":"quadrado100-f36","N2.03":"comparacao-simbolica","N2.07":"fatores-retangulos-f66","N3.01":"visual-addition-f13","N3.02":"emojirow-riscar-f15","N3.03":"counting-on-f14","N4.01":"equal-groups-f97","N4.10":"divisao-longa-f69","N5.01":"partes-iguais-f45","N5.02":"fracao-numero-f72","N5.03":"fracoes-equivalentes-f73","N6.01":"decimos-centesimos-f75","N6.03":"porcentagem-f87","N7.01":"reta-completa-f84","N7.02":"operar-negativos-f85","AL.03":"skip-count-f30","AL.04":"regra-sequencia-f57","AL.05":"igualdade-equilibrio-f46","AL.06":"expressao-f77","AL.07":"linguagem-letras-f89","GE.03":"detetive-formas-f58","GE.04":"solidos-geometricos-f59","GE.05":"mapa-tesouro-f60","GE.06":"angulos-f78","GE.07":"poligonos-f79","GE.08":"plano-cartesiano-f80","GE.09":"circulo-areas-f91","GM.05":"regua-f61","GM.06":"horas-minutos-f62","GM.07":"perimetro-f63","GM.08":"area-f81","GM.09":"problemas-medida-f82","GM.10":"conversao-unidades-f93","PE.02":"jornal-turma-f64","PE.03":"media-chance-f83"};
