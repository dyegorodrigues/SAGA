...
const COMPOSER_FICHAS: Record<string, FichaCompetencia> = {
  ...
  "GM.01":GM_01,"GM.02":GM_02,"GM.05":GM_05,"GM.07":GM_07,"GM.12":GM_12,
  "PE.02":PE_02,
};
