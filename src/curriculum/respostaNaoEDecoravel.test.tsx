...
const REGISTRO: Record<string, { niveis: number[]; porque: string }> = {
  ...
  "GE.05": { niveis: [1, 2, 3, 4, 5], porque: "a casa do mapa é sempre a mesma por nível" },
  "GE.06": { niveis: [1, 2, 3, 4, 5], porque: "a classe do ângulo é sempre a mesma por nível" },
  "GE.08": { niveis: [1, 2, 3, 4, 5], porque: "o par ordenado é sempre o mesmo por nível" },
  "GE.10": { niveis: [1, 2, 3, 4, 5], porque: "a vista pedida é sempre a mesma por nível" },
