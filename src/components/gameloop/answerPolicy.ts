...
export const PALCOS_QUE_RESPONDEM = new Set([
  ...
  "reta-completa-f84", "operar-negativos-f85", "expressao-f77", "voltar-contando-f31", "dobros-f32", "fazer-dez-f33", "familia-aditiva-f16", "voltar-pelo-dez-f34", "pictograma-f56", "dinheiro-f53",
